...
<body>
	...
	<div class="login">
		...
		<ul>
			<li>
				<a href="auth/logout.php">HOW TO ORDER</a>
			</li>
		</ul>
	</div>
	...
	<div class="beli">
		<a href="user/t_pesan.php"><img src="img/kb.png"></a>
	</div>
	...
	<div class="top">
		<ul>
			...
			<li><a href="makanan.php">MAKANAN RINGAN</a></li>
  			...
  			<li><a href="baju	.php">FASION</a></li>
		</ul>
	</div>
	<div class="imgkampus">
	...
	<div id="table1">
		<table border="0">
 			<tr>
    			<th valign="top"><a href="#"><img src="img/buku/buku.jpg" width="600" height="605"></a></th>
    			<th valign="top"><a href="#"><img src="img/jasa/jasa.jpg" width="607" height="300"><img src="img/makanan/makanan.jpg" width="309" height="300">&ensp;<img src="img/fashion/pakaian1.jpg" width="290" height="300"></a></th>
  			</tr>
		</table>
	</div>
	<br>
	<hr size="10px;" style="background-color: orange;">
	<br>
	<?php
		...
		<table border="0" width="1215">	
			<tr>
				<th><p><a href="#"><img src="img/Fashion/pakaian1.jpg" width="220" height="190"></p>
					...
					<a href="#" style="text-decoration: none; color: black;">IDR 150000
